...
typedef void (*pfnStrvCc)(const char*, char*);
typedef void (*pfnStrv4Ccib)(const char*, char*, int, BOOL);
typedef void (*pfnStrvc)(char*);
typedef void (*pfnStrvcib)(char*, int, BOOL);
typedef void (*pfnStrv3cii)(char*, int, int);
typedef int  (*pfnStri2CC)(const char*, const char*);
typedef int  (*pfnStri4CCib)(const char*, const char*, int, BOOL);
typedef void (*pfnStrv2cc)(char*, char);
typedef void (*pfnStrv4ccib)(char*, char, int, BOOL);
typedef BOOL(*pfnStrb1)(const char*);
typedef BOOL(*pfnStrb2)(const char*, const char*);
typedef int  (*pfnStri1)(const char*);
typedef void (*pfnStrv1)(char*);
typedef void (*pfnStrv1)(const char*);
