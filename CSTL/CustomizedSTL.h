...
template <class T>
class EXPORT_CLASS GEN_SLLL : protected Linked_List<T>
{
private:
...
template <class T>
class EXPORT_CLASS GEN_SCLL : protected Linked_List<T>
{
private:
	struct node<T> *Head;
	struct node<T> *Tail;
...
template <class T>
class EXPORT_CLASS GEN_DLLL : protected Linked_List<T>
{
private:
	struct dnode<T> *Head;
	struct dnode<T> *Tail;
...
template <class T>
class EXPORT_CLASS GEN_DCLL : protected Linked_List<T>
{
private:
	struct dnode<T> *Head;
	struct dnode<T> *Tail;
...
template <class T>
class EXPORT_CLASS GEN_PRI_QUEUE
{
private:
